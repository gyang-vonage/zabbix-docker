...
update_zbx_config() {
    ...
    update_config_var $ZBX_CONFIG "TLSCertFile" "zabbix.mon1.mem.dev.use1.vonagenetworks.net.crt"
    ...
    update_config_var $ZBX_CONFIG "TLSKeyFile" "zabbix.mon1.mem.dev.use1.vonagenetworks.net.key"
